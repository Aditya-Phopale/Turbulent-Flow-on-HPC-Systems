...
#include "hStencilKE.hpp"

#include "Definitions.hpp"
#include "StencilFunctions.hpp"

Stencils::hStencilKE::hStencilKE(const Parameters& parameters):
  FieldStencil<TurbulentFlowFieldKE>(parameters) {}

void Stencils::hStencilKE::apply(TurbulentFlowFieldKE& flowField, int i, int j) {
...
void Stencils::hStencilKE::apply(TurbulentFlowFieldKE& flowField, int i, int j, int k) {
